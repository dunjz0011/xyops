// PTOps Multi-Conductor Management Layer
...
class Multi {
	...
	api_get_master_releases(args, callback) {
		// get list of available PTOps versions to install
		var self = this;
		...
		// custom ttl for PTOps releases (so we don't hit GH too often)
		...
		this.loadSession(args, function(err, session, user) {
			...
			// use cached PTOps release data, or fetch from origin if stale
			fs.stat( cache_file, function(err, stats) {
				...
				// use cached file
				self.logDebug(9, "Using PTOps release cache: " + cache_file);
