...
class Util {
	...
	convertCronicleDataFile(opts, callback) {
		// convert Cronicle export file to PTOps-compatible format in place
		var self = this;
		...
		var convertPrivs = function(user) {
			// convert Cronicle privileges to PTOps, including category and group restrictions
		...
		var convertEventPage = function(key, value) {
			...
			value.items.forEach( function(event, idx) {
				...
				// - in PTOps it means "fully disabled in every way"
